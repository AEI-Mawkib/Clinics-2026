...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (p === '/api/analytics' && req.method === 'GET') {
      ...
      const edges = [[1,'0-1 min'],[3,'1-3 min'],[5,'3-5 min'],[8,'5-8 min'],[10,'8-10 min'],
        [15,'10-15 min'],[20,'15-20 min'],[30,'20-30 min'],[60,'30-60 min'],[Infinity,'60+ min']];
      const buckets = {};
      for (const [, label] of edges) buckets[label] = 0;
...
// One file per day, named with the site + date. Runs once at startup and then
// every 24 hours.
